...
export default function LivePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center text-sm text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-950">
    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center px-6">
        <div className="max-w-md w-full bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-8 shadow-xl text-center space-y-4">
          <h1 className="text-2xl font-serif text-slate-900 dark:text-slate-100">Sign in to go live</h1>
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link
              href="/signup"
              className="w-full py-3 rounded-2xl text-sm font-bold text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 transition"
            >
              Create account
            </Link>
          </div>
          <Link href="/" className="text-xs font-semibold text-slate-500 dark:text-slate-400 hover:text-slate-700">
            Back to home
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="relative">
      <div className="fixed top-4 right-4 z-50 flex items-center gap-2">
        <Link
          href="/"
          className="px-4 py-2 rounded-full bg-white/90 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-700 text-[11px] font-bold uppercase tracking-[0.2em] text-slate-600 dark:text-slate-200 shadow-sm hover:bg-white dark:hover:bg-slate-800 transition"
        >
          Home
        </Link>
        <button
